...
def create_cutflow_histogram(cuts, data, xlabel="", ylabel="Selection efficiency", title="", save_path=None):
    """
...
create_cutflow_histogram(cuts, 
                         ...
                         save_path="cutflow_TOT_electron_tau_selection.pdf")
# create_cutflow_histogram(cuts, 
#                          data={"UL2018": values18},
#                          save_path="cutflow_electron_selection_2018UL_A.pdf")