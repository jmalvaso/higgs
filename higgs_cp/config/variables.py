    ...
    cfg.x.keep_columns = DotDict.wrap({
        "cf.ReduceEvents": {
            ...
            "deterministic_seed", "process_id", "cutflow.*",
                ...
                "pt","eta","phi","mass","dxy","dz", "charge", 
                "pfRelIso03_all", "Electron.mvaIso_WP90"
                ] 
        } | {
...
def add_variables(cfg: od.Config) -> None:
    ...
    cfg.add_variable(
        name="electron_phi",
        expression="Electron.phi",
        null_value=EMPTY_FLOAT,
        binning=(20, -3.14159, 3.14159),
        x_title=r"electron $\varphi$",
    )
    ...
    cfg.add_variable(
        name="electron_mT",
        expression="Electron.mT",
        null_value=EMPTY_FLOAT,
        binning=(40, 0.0, 200.0),
        unit="GeV",
        x_title=r"leading electron $m_{T}$",
    )   
