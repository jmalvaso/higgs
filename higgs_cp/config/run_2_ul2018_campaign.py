...
def add_run_2_ul2018_campaign(ana: od.Analysis,
    ...
    dataset_names = ["data_egamma_ul2018_a"]
    ...
    #     (
    #         "data_egamma_ul2018_a", {
    #             "Ele30_WPTight_Gsf","LooseDeepTauPFTauHPS180_L2NN_eta2p1","Ele24_eta2p1_WPTight_Gsf_LooseDeepTauPFTauHPS30_eta2p1_CrossL1",
    #         },
    #         # "SingleTau", {
    ...
    # }
    from higgs_cp.config.triggers import add_triggers_run2_2018_UL
    add_triggers_run2_2018_UL(cfg)
